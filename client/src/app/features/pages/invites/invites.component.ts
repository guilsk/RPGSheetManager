...
export class InvitesComponent implements OnInit {
	...
	private loadInvites(): void {
		...
		this.isLoading = true;
		this.campaignService.getInvitesByPlayerId(this.currentUserId).subscribe({
	...
	public async acceptInvite(campaign: Campaign): Promise<void> {
		...
		this.campaignService.acceptInvite(campaign.id, this.currentUserId).subscribe({
	...
	public async declineInvite(campaign: Campaign): Promise<void> {
		...
		this.campaignService.declineInvite(campaign.id, this.currentUserId).subscribe({
			next: (success: boolean) => {
				if (success) {
